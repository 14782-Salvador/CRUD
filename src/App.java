    ...
    public static void main(String[] args) throws Exception {
        ...
        server.createContext("/produtos", exchange -> {
            ...
            html.append("""
                        ...
                        <a href='/novoP'>+ Novo Produto</a><br><br>
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    html.append("<a href='/editarP?id=").append(id).append("'>Editar</a>");

                    html.append("<a href='/apagarP?id=").append(id)
        ...
        server.createContext("/novoP", exchange -> {
            ...
            html.append("""
                        ...
                        <form method='POST' action='/guardarP'>
        ...
        server.createContext("/guardarP", exchange -> {
            ...
            try {
                ...
                html.append("""
                            ...
                            <a href='/novoP'>Inserir novo produto</a>
        ...
        server.createContext("/editarP", exchange -> {
            ...
            try {
                ...
                html.append("""
                            ...
                            <form method='POST' action='/atualizarP'>
                        """);

                html.append("<input type='hidden' name='id' value='").append(id).append("'>");

                html.append("Ref Produto:<input name='refproduto' value='")
                        .append(refproduto).append("' required>");

                html.append("Produto:<input name='produto' value='")
                        .append(produto).append("' required>");

                html.append("Preco:<input name='preco' value='")
                        .append(preco).append("' required>");
        ...
        // ATUALIZAR PRODUTO
        server.createContext("/atualizarP", exchange -> {
        ...
        // ELIMINAR PRODUTO
        server.createContext("/apagarP", exchange -> {
